...
function changeNextBg(flag) {
    ...
    flag == 1 ? idx = (idx + 1) % imgList.length : idx = (idx - 1 + imgList.length) % imgList.length // 使用了模运算，使得idx始终在0到imgList.length-1之间循环
    topBg.style.backgroundImage = 'url(' + imgList[idx] + ')'
}
