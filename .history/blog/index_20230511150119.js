window.onscroll = function () {
    ...
    height >= 300 ? goTop.style.display = 'block' : goTop.style.display = 'none'
}
...
function changeNextBg(flag) {
    ...
    flag == 1 ? index = (index + 1) % imgList.length : index = (index - 1 + imgList.length) % imgList.length // 使用模运算，使得idx始终在0到imgList.length-1之间循环
