window.onload = function () {
    ...
    top.onmouseout = function () {
        top.style = 'margin-top:-50px'
    }
}
window.onscroll = function () {
    var btnHeight = document.documentElement.scrollTop || document.body.scrollTop
    btnHeight >= 300 ? goTop.style.display = 'block' : goTop.style.display = 'none'
}
// 文章跳转
!(function () {
